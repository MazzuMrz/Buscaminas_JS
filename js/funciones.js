...
let altura = prompt("Cuantos cuadrados de alto quiere? Min: 10")
let ancho = prompt("Cuantos cuadrados de ancho quiere? Min: 10")
if (altura < 10 && ancho < 10 ) {
    alert("ingrese valores validos porfavor")
} else {
    let dif = prompt("Escriba la dificultad deseada")
if (dif == "1") {
    alert("Dificultad facil")
   
        buscaminas.numFilas = ancho;
        buscaminas.numColumnas = altura;
    ...
    if (dif == "2") {
        alert("Dificultad masomenos")
        
        buscaminas.numFilas = ancho;
        buscaminas.numColumnas = altura;
            buscaminas.numMinasTotales = 20;
            pintarTablero();
            generarCampoMinasVacio();
            esparcirMinas();
            contarMinas();
        ...
        if (dif == "3") {
            alert("Imposible de locos!!!!!!")
          
            buscaminas.numFilas = ancho;
            buscaminas.numColumnas = altura;
                buscaminas.numMinasTotales = 100;
                pintarTablero();
                generarCampoMinasVacio();
                esparcirMinas();
                contarMinas();
            ...
            alert("Ingrese un valor valido porfavor")
            mintot == 30
